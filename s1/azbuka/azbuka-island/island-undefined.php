...
<section class="azbuka-section">
	<div class="container">
		<div class="azbuka-game opened-category bukva undef main-page">
			...
			<div class="island-detail-wrapper bukva-undefined">
				<div class="swiper swiper-5">
					<div class="swiper-wrapper">
						<div class="swiper-slide" style="background: #CCEEF5;">
							<div class="close">
								<a href="/azbuka/islands/azbuka-zdorovogo-pitaniya/">
									<svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<img class="bukva-undefined-img" src="/layout/img/azbuka-game/island-undefined.png" alt="">
						</div>
					</div>
				</div>
