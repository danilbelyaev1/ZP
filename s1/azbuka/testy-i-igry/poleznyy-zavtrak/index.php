...
<section class="azbuka-section games">
	<div class="container">
		<div class="azbuka-game opened-category games poleznyy-zavtrak">
			...
			<div class="island-detail-wrapper">
				<div class="game-window">
					...
					<div class="game-title">Найдите полезный завтрак</div>
					<div class="swiper swiper-game">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img class="true" src="../../../layout/img/azbuka-game/poleznyy-zavtrak/1.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/2.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/3.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/4.png" alt="">
							</div>
							<div class="swiper-slide">
								<img class="false" src="../../../layout/img/azbuka-game/poleznyy-zavtrak/1.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/2.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/3.png" alt="">
								<img src="../../../layout/img/azbuka-game/poleznyy-zavtrak/4.png" alt="">
							</div>
