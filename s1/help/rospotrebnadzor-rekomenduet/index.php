...
$APPLICATION->SetTitle("Роспотребнадзор рекомендует  | Проект Роспотребнадзора РФ «Здоровое питание»");
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="side-content">
					<h2 class="title">Роспотребнадзор рекомендует</h2>
					...
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"AREA_FILE_SUFFIX" => "inc",
							"EDIT_TEMPLATE" => "",
							"PATH" => "/local/templates/refactor/include/help/rospotreb.php"
						)
					);?>
