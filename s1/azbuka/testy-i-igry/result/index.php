...
<section class="azbuka-section games">
	<div class="container">
		<div class="azbuka-game opened-category games main-page">
			...
			<div class="island-detail-wrapper">
				<div class="game-window result">
					...
					<div class="game-title">Ты молодец, отлично справился с заданием!</div>
...
<!--					<p>Изучите материалы еще раз, чтобы питаться правильно!</p>-->
					...
					<a href="../ugadayte-frukt/" class="btn btn-primary grey">Пройти игру еще раз</a>
				</div>
			</div>
		</div>
	</div>
